...
const AutocompleteMap = () => {
  ...
  return (
    <main className='flex flex-col md:flex-row justify-center items-center w-full h-full'>
      <section className='bg-primary md:w-1/2 w-full md:h-full h-2/4 flex flex-col items-center md:justify-center justify-start md:gap-10 gap-2 py-8'>
        <h1 className='md:text-5xl text-3xl text-medium text-center px-6'>¿Dónde te robaron?</h1>
